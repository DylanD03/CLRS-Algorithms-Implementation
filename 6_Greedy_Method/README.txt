This program uses a greedy algorithm to calculate the lowest 'burst' value needed to climb a mountain. Where a burst value is the distance you can climb after a rest.
